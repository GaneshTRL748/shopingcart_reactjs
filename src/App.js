...
function App() {
  ...
  return (
     <React.Fragment>
        ...
        {
          click?<Cart cart={cart} setClick={SetClick} handlequantity={handlequantity} removeitem={removeitem}/>: <Content additem={additem} list={list1} cartbtnoperation={cartbtnoperation}/>
        }
     </React.Fragment>
  );
}
